    ...
    <>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {adminMetrics.map((metric) => {
          ...
          return (
            <article key={metric.label} className="rounded-lg premium-card p-5">
      ...
      <section className="mt-6 grid gap-6 xl:grid-cols-[1fr_0.8fr]">
        <div className="rounded-lg premium-card p-5">
          <h2 className="text-lg font-black text-slate-950">Recent trips</h2>
        ...
        <div className="rounded-lg luxury-panel p-5 text-white soft-ring">
