    ...
    <>
      ...
      <aside
        className={classNames(
          'fixed inset-y-0 left-0 z-50 w-72 border-r border-white/70 bg-white/90 shadow-2xl shadow-orange-100/50 backdrop-blur-xl transition-transform lg:sticky lg:top-0 lg:z-20 lg:h-screen lg:translate-x-0 lg:shadow-none',
      ...
      >
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  classNames(
                    ...
                    isActive ? 'bg-gradient-to-r from-orange-50 to-sky-50 text-sky-800 shadow-sm' : 'text-slate-600 hover:bg-white hover:text-slate-950',
                  )
                }
              >
        ...
        <div className="m-4 rounded-lg luxury-panel p-4 text-white soft-ring">
