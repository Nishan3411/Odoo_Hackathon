    ...
    <header className="sticky top-0 z-30 border-b border-white/70 bg-white/80 backdrop-blur-xl">
      <div className="flex h-16 items-center gap-3 px-4 lg:px-6">
        ...
        <div className="hidden max-w-lg flex-1 md:block">
          <Input icon={Search} placeholder="Search routes, stays, cities, activities" className="bg-white/90" />
        </div>
        <div className="ml-auto flex items-center gap-2">
          <Link to="/create-trip" className="hidden sm:inline-flex">
          ...
          <button
            ...
            className="hidden rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 transition hover:border-sky-200 hover:text-sky-700 sm:inline-flex"
          >
