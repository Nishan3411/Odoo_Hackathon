...
function ActivityCard({ activity }) {
  ...
  return (
    <article className="rounded-lg border border-slate-200 bg-white p-4 transition hover:-translate-y-1 hover:border-teal-200 hover:shadow-lg">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <h3 className="mt-1 font-bold text-slate-950">{activity.name}</h3>
            </div>
